...
const TopBar = () => {
  return (
    <div className="bg-[#182335] min-h-[10vh]  flex items-center justify-end ">
      <div className="flex   items-center gap-x-3 container justify-end">
        <p className="flex flex-col">
          <span className="text-[17px] font-bold">Kamrul hasan</span>{" "}
          <span className="text-sx">kamrul@gmail.com</span>
        </p>
        <div className="cursor-pointer group relative w-1/12">
          <Image
            src="/my.jpg"
            height={70}
            width={70}
